...
#define Yc(i)  (int) ( 298  * ( i - 16 )) // Y contribution
#define Ucg(i) (int) ( -100 * ( i - 128 ))// U contribution to G
#define Ucb(i) (int) ( 516  * ( i - 128 ))// U contribution to B
#define Vcr(i) (int) ( 409  * ( i - 128 ))// V contribution to R
#define Vcg(i) (int) ( -208 * ( i - 128 ))// V contribution to G
